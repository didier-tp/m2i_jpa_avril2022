...
class TestDaoCommande {
	...
	void testCommande_LigneCommande() {
		Commande c1 = daoCommande.insert(new Commande(null,new Date()));//first save to have a auto_incr command number
		...
		Commande c2 = daoCommande.insert(new Commande(null,new Date()));//first save to have a auto_incr command number
